...
static int16_t playbackBufferLeft[MY_BUFFER_SIZE_SAMPLES];
static int16_t playbackBufferRight[MY_BUFFER_SIZE_SAMPLES];
                             ...
                             uint32_t num_samples)
{
    ...
    {
        /*
          the process_sample_left() function is defined in
          ece5210.c
